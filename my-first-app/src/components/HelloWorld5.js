import React, {useState, useEffect} from 'react';
    ...
    The two effects document.title and window.alert could have been put under one useEffect but I want to illustrate that in the case of window.alert, we want it to be fired only on the condition that count value changes. Otherwise, it will show whenever the component is update at all including when writing name to greet.
    */
    useEffect(() => {
